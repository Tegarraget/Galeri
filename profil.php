        ...
        <div class="container">
            ...
            <div class="box">
               ...
               <form action="" method="POST">
                   ...
                   <input type="submit" name="submit" value="Ubah Profil" class="btn" style="background-color: #518df5; color: #fff;">
               </form>
               <?php
            ...
            <div class="box">
               <form action="" method="POST">
                   ...
                   <input type="submit" name="ubah_password" value="Ubah Password" class="btn" style="background-color: #518df5; color: #fff;">
               </form>
               <?php
...
<a href="hapus.php?dlt=<?php echo $d->user_id ?>" onclick="return confirm('Yakin Ingin Hapus ?')"><button style="padding: 8px 10px; background-color: #518df5; color: black; border: none; cursor: pointer;">Delete Akun</button></a>
